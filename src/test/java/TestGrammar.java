...
public class TestGrammar {
    ...
    @Test
    public void testSimpleDataObjectQuery() throws Exception {
        String queryString = "dataObject-Name[]";
    ...
    @Test
    public void testFullDataObjectQuery() throws Exception {
    ...
    @Test
    public void testSimpleDataElementQuery() throws Exception {
        String queryString = "dataObjectName/data_ElementName[]";
    ...
    @Test
    public void testFullDataElementQuery() throws Exception {
